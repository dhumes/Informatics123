...
GAME_STOPPED, GAME_START, GAME_SCRAMBLE, GAME_ACTIVE, GAME_WIN, GAME_STOP =\
    range (6)
...
class s:
    ...
    game_state, game_level, game_tick, game_scram_speed, game_win_len = [
        0, 0, 0, 30, 50]
...
def init ():
    ...
    s.img_board = pygame.image.load (
        os.path.join ("data", "board.png")).convert_alpha()
    s.img_puzzle = pygame.image.load (
        os.path.join ("data", "puzzle.jpg")).convert()

    for i in range (6):
        s.img_arrow += [pygame.image.load (
            os.path.join ("data", "arrow" +str(i) +".png")).convert_alpha()]

    for i in range (2):
        s.img_power += [pygame.image.load (
            os.path.join ("data", "power" +str(i) +".png")
        ).convert_alpha()]

    for i in range (5):
        s.img_win += [pygame.image.load (
            os.path.join ("data", "win" +str(i) +".png")).convert_alpha()]
    ...
    s.sound_win = pygame.mixer.Sound (os.path.join ("data", "win.ogg"))
    s.sound_buzz = pygame.mixer.Sound (os.path.join ("data", "buzz.ogg"))
    for i in range (s.sound_slide_n):
        s.sound_slide += [
            pygame.mixer.Sound (os.path.join ("data", "sl"+str(i) + ".ogg"))
        ]
